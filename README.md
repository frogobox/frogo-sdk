...
This Is Latest Release
    ...
    $version_release = 3.0.8

What's New?? (v3.0.5 → v3.0.8)
...
dependencies {
    // Core SDK
    implementation("com.github.frogobox:frogo-sdk:3.0.8")

    // Or specific modules (recommended)
    implementation("com.github.frogobox.frogo-sdk:frogo-compose-ui:3.0.8")
    implementation("com.github.frogobox.frogo-sdk:frogo-ext-ads:3.0.8")
}
```
