...
@Preview(name = "FrogoAdmobComposeActivity", showBackground = true, showSystemUi = true)
@Composable
private fun FrogoAdmobComposeActivityPreview() {
    Surface(
        ...
        Column(
            ...
            Text(
                text = "FrogoAdmobComposeActivity",
